<template>
  <div class="container mx-auto mt-5">
    <h1 class="text-3xl font-bold mb-4">A Bili-video Analyzer & Downloader</h1>

    <p class="text-gray-500">稳定下载为固定下载链接 速度较慢 不会失效 使用<a href="https://sccube.link/api" target="_blank">自建api</a>实现</p>
    <p class="text-gray-500">高速下载链接为B站官方CDN节点(阿里云) 速度较快 会失效 请勿长时间下载</p>
    <br>
    <p class="text-gray-500">Made with 
